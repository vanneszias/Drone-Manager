...
export default function Features() {
  ...
  return (
    <section id="features" className="relative w-full py-12 md:py-24 lg:py-32 bg-black">
      {/* Simpelere gradient achtergrond */}
      ...
      <div className="container relative z-10 px-4 md:px-6 mx-auto max-w-7xl">
        ...
        <div className="mx-auto grid max-w-6xl grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 mt-12">
          <Card className="transition-all hover:shadow-lg bg-black/50 border border-white/20 text-white">
            ...
            <CardFooter>
              <Button variant="ghost" className="gap-1 p-0 hover:bg-transparent hover:underline text-green-400">
          ...
          <Card className="transition-all hover:shadow-lg bg-black/50 border border-white/20 text-white">
            ...
            <CardFooter>
              <Button variant="ghost" className="gap-1 p-0 hover:bg-transparent hover:underline text-blue-400">
                Learn more <ChevronRight className="h-4 w-4" />
              </Button>
            </CardFooter>
          </Card>
          <Card className="transition-all hover:shadow-lg bg-black/50 border border-white/20 text-white">
            ...
            <CardFooter>
              <Button variant="ghost" className="gap-1 p-0 hover:bg-transparent hover:underline text-sky-300">
                Learn more <ChevronRight className="h-4 w-4" />
              </Button>
            </CardFooter>
          </Card>
